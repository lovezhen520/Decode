...
class UserInfo {
  ...
  async getUserSpaceSignInDetail(_0x5043c1) {
    try {
      ...
      let _0xd5fc5b = await this.fetch(_0xaa8938);
  ...
  async getTasks(_0x44071f) {
    try {
      ...
      let _0x26ba84 = await this.fetch(_0x4ded10);
  ...
  async signin(_0x5e9fad, _0x230feb) {
    try {
      ...
      let _0x2f93b1 = await this.fetch(_0x101a53);
  ...
  async getArticles() {
    try {
      ...
      let _0x29eb66 = await this.fetch(_0x4bf6c8);
  ...
  async getEbooks() {
    try {
      ...
      let _0x191e83 = await this.fetch(_0x1b765a);
  ...
  async getAsks() {
    try {
      ...
      let _0x3dae2e = await this.fetch(_0x42f8c5);
  ...
  async getAskDetail(_0x4421d8) {
    try {
      ...
      let _0x5db388 = await this.fetch(_0x39e0d6);
  ...
  async getCsrfToken(_0x7ba456, _0x3ceff9) {
    try {
      ...
      const _0x54ed04 = _0x4168fd,
        _0x10f5d7 = await this.fetch(_0x54ed04);
  ...
  async voteAnswer(_0x341031, _0x2d8ad0, _0x18ae10, _0x358eba) {
    try {
      ...
      const _0x491e2 = _0x3d9cfd;
      await this.fetch(_0x491e2);
  ...
  async addBookComment(_0x2e34eb, _0x55367e) {
    try {
      ...
      const _0x26c605 = _0x4db917,
        _0x2415c8 = await this.fetch(_0x26c605);
  ...
  async getFavors() {
    try {
      ...
      const _0xd74074 = {
        ...
        _0x2c78d3 = await this.fetch(_0xd74074),
        {
          list: _0x1e0077
        } = _0x2c78d3?.["data"];
      if (_0x1e0077.length) {
  ...
  async interactData() {
    try {
      ...
      let _0x4e21f0 = await this.fetch(_0x2e8af0);
  ...
  async getUserTotalPendingScore() {
    try {
      ...
      let _0x57b0ae = await this.fetch(_0x59723c);
  ...
  async collect() {
    try {
      ...
      let _0x13a401 = await this.fetch(_0x5a8480);
...
async function getCookie() {
  ...
  const _0x5f1b08 = userCookie.findIndex(_0x1f0cd8 => _0x1f0cd8.userId == _0x177534.userId);
  userCookie[_0x5f1b08] ? userCookie[_0x5f1b08] = _0x177534 : userCookie.push(_0x177534);
  $.setjson(userCookie, ckName);
  $.msg($.name, "🎉" + _0x177534.userName + "更新token成功!", "");
}
...
async function getWxToken(_0x32debd) {
  try {
    ...
    const _0x3d2d01 = _0x31db1f;
    let _0x5304fd = await Request(_0x3d2d01),
